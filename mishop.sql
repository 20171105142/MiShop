...
CREATE TABLE `tb_addresses`  (
  ...
  `addresses_receiverName` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `addresses_receiverAddress` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `addresses_receiverDetailAddress` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `addresses_receiverPhone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `addresses_isDefaultAddress` int(1) NOT NULL,
  PRIMARY KEY (`addresses_id`) USING BTREE,
  INDEX `Adduserid`(`addresses_userId`) USING BTREE,
  CONSTRAINT `Adduserid` FOREIGN KEY (`addresses_userId`) REFERENCES `tb_users` (`users_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of tb_addresses
-- ----------------------------
INSERT INTO `tb_addresses` VALUES (1, 1, '喵喵喵', '福建省 福州市 鼓楼区 温泉街道', '五四路159号世界金龙大厦20层B北 福州rpg.blue网络', '14747575027', 0);
INSERT INTO `tb_addresses` VALUES (2, 1, '米正龙', '内蒙古自治区 呼和浩特市 和林格尔县 师大东路', '内蒙古师范大学', '14747575027', 1);
INSERT INTO `tb_addresses` VALUES (3, 1, '王京', '北京市 北京市  东城区 长安街', '天安门', '18519000419', 0);
...
-- Records of tb_carts
-- ----------------------------
INSERT INTO `tb_carts` VALUES (1, 1, 1, '粉红色', 'S', '4');
INSERT INTO `tb_carts` VALUES (2, 1, 1, '粉红色', 'XL', '2');
INSERT INTO `tb_carts` VALUES (3, 1, 1, '黄色', 'M', '1');
...
CREATE TABLE `tb_users`  (
  ...
  `users_address` varchar(2048) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- Records of tb_users
-- ----------------------------
INSERT INTO `tb_users` VALUES (1, '14747575027', 'aaa111', '2020-06-10 01:03:50', 'W', '2020-06-19', NULL);
INSERT INTO `tb_users` VALUES (2, '14747575023', 'aaa111', '2020-06-10 10:13:12', NULL, NULL, NULL);
INSERT INTO `tb_users` VALUES (3, '14747575021', 'aaa111', '2020-06-11 22:30:11', NULL, NULL, NULL);
