...
public class CartDAO {
	...
	public int changeGoodsAmout(String type, int users_id, int goods_id, String goods_color, String goods_size, int newAmout) {
		// TODO Auto-generated method stub
		Connection conn = DBUtil.getConnection();
		PreparedStatement pstmt = null;
	...
	public int delGoods(String type, int users_id, int goods_id, String goods_color, String goods_size) {
		// TODO Auto-generated method stub
		Connection conn = DBUtil.getConnection();
		PreparedStatement pstmt = null;
		
		String sql = "DELETE FROM tb_carts WHERE carts_userid=? "
				+ "and carts_goodsid=? and carts_goodscolor=? and carts_goodssize=?;";
		int status = 0;
		try {
			pstmt = conn.prepareStatement(sql);
