...
<body>
			...
			<div class="pull-right">
				<div class="user-content__box clearfix bgf">
					...
					<div class="port b-r50" id="crop-avatar">
						<div class="img"><img src="<%=request.getContextPath() %>/images/icons/default_avt.png" class="cover b-r50"></div>
					</div>
					<%
						Users userinfo = recommend.getUserInfo(users.getUsers_id());
					%>								
					<form action="" class="user-setting__form" role="form">
						<div class="user-form-group">
							<label for="user-id">用户名：</label>
							<input type="text" id="user-id" value="<%=users.getUsers_phone() %>" placeholder="请输入您的昵称">
						</div>
						<div class="user-form-group">
							<label>等级：</label>
						...
						<div class="user-form-group">
							<label>生日：</label>
							<label><input type="text" name="brithday" class="datepicker" value="<%=userinfo.getUsers_birthday() %>" placeholder="请选择您的出生日期"></label>
						</div>
						<div class="user-form-group">
					...
					<script src="<%=request.getContextPath() %>/js/zebra.datepicker.min.js"></script>
					<link rel="stylesheet" href="<%=request.getContextPath() %>/css/zebra.datepicker.css">
					
					<script>
					$(document).ready(function(){
						$(":radio[name='sex'][value='<%=userinfo.getUsers_sex() %>']").prop("checked", "checked");
						...
						//ajax提交用户信息
						$(".btn").click(function(){
							var sex = $(this).parent().siblings(".user-form-group").children().children('input[name="sex"]:checked').attr("value")
							var birthday = $(".datepicker").val()
							$.ajax({
					            url: "<%=request.getContextPath() %>/UpdateUserInfoServlet",			
					            type: "post",
					            data:{
	...
	<!-- 头像选择模态框 -->
	<link href="<%=request.getContextPath() %>/css/cropper/cropper.min.css" rel="stylesheet">
	<link href="<%=request.getContextPath() %>/css/cropper/sitelogo.css" rel="stylesheet">
	<script src="<%=request.getContextPath() %>/js/cropper/cropper.min.js"></script>
	<script src="<%=request.getContextPath() %>/js/cropper/sitelogo.js"></script>
